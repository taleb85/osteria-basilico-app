...
COMMENT ON COLUMN public.users.hide_from_team_schedule IS 'Se true, utente attivo ma non mostrato in tabellone turni, presenze collettive e riepilogo ore team';
