...
export function MessageWriter({
  ...
  if (compact) {
    return (
      <div className="space-y-3 rounded-lg border-2 border-amber-300/80 bg-amber-50/80 p-3 dark:border-amber-600/60 dark:bg-amber-950/40">
        ...
        {/* Successo */}
        {success && (
          <div className="rounded bg-brand-100 p-2 text-xs font-semibold text-brand-700 dark:bg-[#0052FF]/12 dark:text-brand-300">
            ✓ Messaggio inviato!
          </div>
        )}
  ...
  return (
    <div className="space-y-4 rounded-lg border-2 border-accent/50 bg-accent/5 p-4 dark:border-accent/60 dark:bg-accent/10">
      ...
      {success && (
        <div className="rounded-lg bg-brand-100 p-3 text-sm font-semibold text-brand-700 dark:bg-[#0052FF]/12 dark:text-brand-300">
