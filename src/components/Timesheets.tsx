            ...
            >
              <div ref={timesheetHeaderScrollRef} className="overflow-x-hidden">
                ...
                >
                  ...
                  <thead>
                    <tr className="border-b border-white/20" style={{ background: 'rgba(15, 40, 90, 0.85)' }}>
                      <th className="sticky left-0 z-10 box-border py-3.5 pl-4 pr-3 text-center text-[11px] font-semibold uppercase tracking-wider text-white border-r border-r-white/20 md:py-2.5 md:pl-3 md:pr-2" style={{ background: 'rgba(15, 40, 90, 0.85)' }}>
                        {t.employee}
                      </th>
                      {weekDays.map((day, dayIdx) => {
                        ...
                        return (
                          <th key={dStr}
                            ...
                            style={{ background: payrollHighlight ? 'rgba(51,102,204,0.35)' : todayDate ? 'rgba(51,102,204,0.25)' : 'rgba(15, 40, 90, 0.85)' }}
                          >
                      ...
                      <th className="box-border border-l border-l-white/20 px-3 py-3.5 text-center text-[11px] font-semibold uppercase tracking-wider text-white md:px-2 md:py-2" style={{ background: 'rgba(15, 40, 90, 0.85)' }}>
                        {t.stats_total}
                      </th>
                    </tr>
                  </thead>
            ...
            >
              ...
              <thead ref={timesheetTheadRef}>
                <tr className="border-b border-white/15">
                  <th className="sticky left-0 z-10 box-border py-2 pl-4 pr-3 text-center text-[11px] font-semibold uppercase tracking-wider text-white/50 border-r border-r-white/15 md:py-1.5 md:pl-3 md:pr-2" style={{ background: 'rgba(15, 40, 90, 0.85)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', boxShadow: 'none' }}>
                    {t.employee}
                  </th>
                  {weekDays.map((day, dayIdx) => {
                    const todayDate = isToday(day);
