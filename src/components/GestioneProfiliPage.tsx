                                ...
                                <AdminRow
                                  ...
                                  action={
                                    <button
                                      ...
                                      className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors focus:outline-none focus:ring-2 focus:ring-accent/50 focus:ring-offset-2 dark:focus:ring-offset-neutral-900 ${user.team_schedule_visible !== false ? 'bg-accent' : 'bg-slate-200 dark:bg-neutral-600'}`}
                                    >
                                      <span
