...
const MENU = [
  ...
  { key: 'roles', label: 'Permessi per ruolo', icon: <SlidersHorizontal className="w-5 h-5" />, component: 'roles' },
  ...
  return (
    <div className="flex flex-col md:flex-row w-full min-h-[80vh]">
      ...
      <div className="flex-1 min-h-0 overflow-y-auto app-horizontal-pad py-4 pb-[max(1.25rem,env(safe-area-inset-bottom,0px))]">
        ...
        {selected === 'roles' && <RoleFeatureTemplatesPanel variant="page" />}
        {selected === 'features' && <ImpostazioniPage />}
        {selected === 'advanced' && (
