      ...
      <div className="flex items-center gap-2 mb-5 px-4">
        ...
        <div className="flex items-center border border-white/10 rounded-2xl overflow-hidden flex-1 supports-[backdrop-filter]:backdrop-blur-md" style={{ background: 'transparent', boxShadow: '0 0 0 1px rgba(0,0,0,0.06)' }}>
          <button type="button" onClick={() => setNavOffset(o => o - 1)}
            className="flex items-center justify-center h-9 w-9 text-white/55 hover:bg-white/8 transition-colors shrink-0 border-r border-white/10">
            <ChevronLeft className="h-4 w-4" />
          </button>
          <div className="flex-1 flex items-center justify-center gap-1.5 px-2 min-w-0">
            <Clock className="h-3 w-3 text-white/55 shrink-0" />
            <span className="text-[10px] font-bold text-white/55 tabular-nums truncate">{rangeLabel}</span>
          </div>
          <button type="button" onClick={() => setNavOffset(o => o + 1)}
            className="flex items-center justify-center h-9 w-9 text-white/55 hover:bg-white/8 transition-colors shrink-0 border-l border-white/10">
